...
public class M0605 extends AppCompatActivity {
    ...
    private void setupViewCOmponent() {
        ...
        txtComPlay = (ImageView)findViewById(R.id.m0605_c001); //******我上支城市沒寫到這個變數？
        ...
        public void onClick(View v) {
            ...
            switch(v.getId()){   //這邊次之2
                case R.id.m0605_b001:  //玩家選剪刀
                    user_select = getString(R.string.m0605_ans1)+" "+getString(R.string.m0605_b001);
                    switch(iComPlay){  //這邊第三3
                        case 1:
                            txtComPlay.setImageResource(R.drawable.scissors);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f003);  // 1123可寫到下面
                        //    txtResult.setTextColor(Color.YELLOW); //平手黃色  // 1123可寫到下面                            break;
                            music(2);
                            break;
                        case 2:
                            txtComPlay.setImageResource(R.drawable.stone);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f002);
                        //    txtResult.setTextColor(Color.RED); //輸用紅色
                            music(3);
                            break;
                        case 3:
                            txtComPlay.setImageResource(R.drawable.net);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f001);
                   ...
                   // switch(iComPlay)
                    break;
                case R.id.m0605_b002:  //石頭
                    user_select = getString(R.string.m0605_ans1)+" "+getString(R.string.m0605_b002);
                    switch(iComPlay){  //這邊第三3
                        case 1:
                            txtComPlay.setImageResource(R.drawable.scissors);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f001);
                        ...
                        case 2:
                            txtComPlay.setImageResource(R.drawable.stone);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f003);
                    ...
                    break;
                case R.id.m0605_b003:  //布
                    user_select = getString(R.string.m0605_ans1)+" "+getString(R.string.m0605_b003);
                    switch(iComPlay){  //這邊第三3
                        case 1:
                            txtComPlay.setImageResource(R.drawable.scissors);
                        //    answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f002);
    ...
    private void music(int i) {
        ...
        switch(i){
            case(1):
                answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f001);
                txtResult.setTextColor(Color.GREEN); //贏用綠色
//                toast = Toast.makeText(getApplicationContext(),getText(R.string.m0605_f001),Toast.LENGTH_SHORT);
//                toast.show();
            ...
            case(2):
                answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f003);
                txtResult.setTextColor(Color.YELLOW); //平手黃色
//                toast = Toast.makeText(getApplicationContext(),getText(R.string.m0605_f003),Toast.LENGTH_SHORT);
//                toast.show();
            ...
            case(3):
                answer = getString(R.string.m0605_ans2)+getString(R.string.m0605_f002);
                txtResult.setTextColor(Color.RED); //輸用紅色
//                toast = Toast.makeText(getApplicationContext(),getText(R.string.m0605_f002),Toast.LENGTH_SHORT);
//                toast.show();
